      ...
      <div className="flex flex-col border border-gray-300 p-2">
        ...
        <div className="flex flex-row place-content-center text-xs text-center">
          <div className="flex flex-col justify-center space-y-1 p-2">
            <div className="bg-green-100 border border-gray-300 hover:bg-gray-200 rounded-lg p-2">
              <NumberInput
            ...
            <div className="bg-red-100 border border-gray-300 hover:bg-gray-200 rounded-lg  p-2">
              <NumberInput
